...
class IssueController extends Controller
{
    ...
    {
        return self::paginated(Issue::paginate(10), null, 'Issues retrieved successfully', 200);
    }
    ...
    public function store(StoreIssueRequest $request)
    {
        ...
        return self::success($issue, 'Issue created successfully', 201);
    }
    ...
    {
        return self::success($issue, 'Issue retrieved successfully', 200);
    }
    ...
    public function update(UpdateIssueRequest $request, Issue $issue)
    {
        ...
        return self::success($issue, 'Issue updated successfully', 200);
    }
    ...
    {
        $issue->delete();
        return self::success(null, 'Issue deleted successfully', 200);
    }
